                ...
                <div class="card-body">
                    ...
                    <form action="../social/upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <hr>
                            <div class="text-center">
                                <button type="submit" <?php if (isset($_SESSION['organization_name'])) { ?> name="organization-forwards" ; <?php } else { ?> name="Personal-forwards" ; <?php } ?> id="submitButton" class="btn btn-outline-info rounded-pill">โพสต์</button>
                            </div>
                    </form>
