...
$sql2 = "SELECT tb_organization_forwards.organization_forward_name,tb_history_personal_forwards.history_forwards_name,tb_history_personal_forwards.history_forwards_detail,tb_history_personal_forwards.history_forward_ct,tb_history_personal_forwards.history_forwards_location,tb_history_personal_forwards.history_forwards_id,tb_history_personal_forwards.history_forwards_date,tb_history_personal_forwards.history_forwards_status FROM tb_organization_forwards,tb_history_personal_forwards WHERE tb_history_personal_forwards.history_forwards_org_id=tb_organization_forwards.organization_forward_id AND tb_organization_forwards.organization_forward_user = '$organization_name' ";
                                ...
                                <?php if (isset($_SESSION['organization_name'])) { ?>
                                    <?php while ($row = mysqli_fetch_assoc($result_2)) { ?>
                                        <tr>
                                            ...
                                            <td><a href="../social/check_status2.php?history_forwards_status=<?php echo $row['history_forwards_id'] ?>" class="btn btn-success<?php if ($row['history_forwards_status'] == 'finish') {
                                                                                                                                                                                    echo ' disabled';
                                                                                                                                                                                } ?>">ยืนยัน</a></td>
                                        </tr>
                                    <?php } ?>
